...
RUN apt-get install -y python3-all-dev libhdf5-dev libatlas-base-dev libopenblas-base libopenblas-dev libbz2-dev glpk-utils glpk-doc libglpk-dev python-glpk
